...
<div class='container' style='min-height: 800px'>
    ...
    <form class=\"form-control\" enctype=\"multipart/form-data\" method='post' action='$domain/create_add_post_help.php'>
    <input type=\"hidden\" name=\"MAX_FILE_SIZE\" value=\"300000\" />
        <br>
        <legend class=\"m-b-1 text-xs-center\"><b>Добавление поста о помощи</b></legend>
        <br>
        ...
        <div class=\"text-xs-center\">
            <input class=\"btn btn-block btn-primary\" type=\"submit\" name='add_post_help' value='Добавить пост'>
        </div>
    </form>
</div>
