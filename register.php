...
<br>";
    ...
    if (!$res=$mysqli->query("CALL AddUser('$_POST[first_name]','$_POST[last_name]','$_POST[middle_name]','$_POST[data]',$_POST[number],'$_POST[email]','$pass', '0')")) {
        echo "Не удалось вызвать хранимую процедуру: (" . $mysqli->errno . ") " . $mysqli->error;
    }


    echo '<div class="container" id="ContNum1">

 <br><h2>Регистрация прошла успешно</h2> <br>  
    </div>
